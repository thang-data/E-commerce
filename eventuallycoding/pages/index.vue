          ...
          <div class="flex flex-col items-center justify-center">
            ...
            <div class="p-5 text-white rounded ">
              <div class="lg:text-7xl md:text-5xl text-2xl font-bruno ">
                <span class="dynamic-letters">Nguyen Duc Thang</span></div>
            </div>
          ...
          <!-- <div class="mt-20 lg:w-3/4 w-full mx-auto lg:px-4 px-0 mb-10">
            ...
            <div class="overflow-hidden overflow-x-auto border border-gray-100 rounded">
              <table class="min-w-full text-sm divide-y divide-gray-200">
                <thead>
                <tr class="bg-gray-50">
                  <th class="px-4 py-2 font-medium text-left text-gray-900 whitespace-nowrap">Past events</th>
                  <th class="px-4 py-2 font-medium text-left text-gray-900 whitespace-nowrap">Titre</th>
                  <th class="px-4 py-2 font-medium text-left text-gray-900 whitespace-nowrap">Venue</th>
...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: "og:title", name: "og:title", content: "Nothing is impossible without trying" },
      { hid: "og:url", name: "og:url", content: "https://nguyenducthang.name.vn" },
      { hid: "og:image", name: "og:image", content: 'https://nguyenducthang.name.vn' + siteMetaInfo.author_image },
      { name: "twitter:text:title", content: "Nothing is impossible without trying" },
      { name: "twitter:image", content: 'https://nguyenducthang.name.vn' +  siteMetaInfo.author_image  },
